...
### AI-Powered Smart Elderly Care Monitoring System
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/ESP32--S3-ESPectre_v2.8-E7352C?style=flat-square&logo=espressif" />
...
- ESPectre v2.8.0 韌體（選用）
- ESPHome 2026.5.0+（若自行編譯 ESPectre v2.8.0 韌體）
...
## 🔌 ESPectre BLE GATT 規格（v2.7.0+ / v2.8.0）
