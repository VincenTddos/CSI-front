...
export function SystemSettings() {
  ...
  const [manualThreshold, setManualThreshold] = useState(String(savedSettings.manualThreshold ?? 1.0));
  ...
  const currentSettings: SystemSettingsState = {
    algorithm,
    thresholdMode,
    manualThreshold: thresholdMode === 'manual' && Number.isFinite(parsedManualThreshold)
      ? Math.max(0, Math.min(10, parsedManualThreshold))
      : null,
    sensitivity,
    lineNotifyEnabled,
    lineToken,
            ...
            <>
              ...
              {thresholdMode === 'manual' && (
                <div className="mb-4">
                  ...
                  <input type="number" min="0" max="10" step="0.1" value={manualThreshold}
